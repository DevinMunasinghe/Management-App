...
import { AppDispatch, RootState, useAppSelector } from '@/app/stores/store';
import { setActiveTab } from '@/app/stores/features/tab';
...
const SideNav = () => {
    ...
    const activeTab = useAppSelector((state: RootState) => state.tabReducer.activeTab)
                ...
                <div className="h-full px-3 py-4 overflow-y-auto bg-gradient-to-b from-[#262B32] text-white">
                    <ul className="space-y-5 font-medium">
                        <li>
                            <Link href="/#" passHref>
                                <div
                                    onClick={() => handleTabClick("addTask")}
                        ...
                        <li>
                            <Link href="/tasks" passHref>
                                <div
                                    onClick={() => handleTabClick("viewTasks")}
                                    className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group
                                        ${activeTab === "viewTasks"
                                            ? "bg-gray-700 text-white"
                                            : "hover:bg-gray-100 dark:hover:bg-gray-700"
